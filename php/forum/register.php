<?php
	...
	$fname = clean($_POST['emailRegister']);
	$lname = clean($_POST['emailRegister']);
	$login = clean($_POST['userRegister']);
	$password = clean($_POST['passRegister1']);
	$cpassword = clean($_POST['passRegister2']);
	...
	//Create INSERT query
	$qry = "INSERT INTO members(firstname, lastname, login, passwd) VALUES('$fname','$lname','$login','".md5($_POST['passRegister1'])."')";
	$result = @mysqli_query($GLOBALS["___mysqli_ston"], $qry);
